...
-- SELECT 
-- lab2.au_id, SUM(T_ROYALTY+ADVANCE)
-- FROM (
-- 	SELECT lab1.au_id, lab1.title_id, ADVANCE, SUM(ROYALTY) AS T_ROYALTY
-- 	FROM (
-- 		SELECT t.title_id, au.au_id, t.advance AS ADVANCE, t.price * sa.qty * t.royalty / 100 * ta.royaltyper / 100 AS ROYALTY
-- 		FROM titles AS t
...
#### CHALLENGE 2: ALTERNATIVE SOLUTION
 ...
 CREATE TEMPORARY TABLE part2
 	SELECT part1.au_id, part1.title_id, ADVANCE, SUM(ROYALTY) AS T_ROYALTY
  	FROM part1
...
SELECT * FROM part2;
 ...
 CREATE TEMPORARY TABLE part3
 	SELECT part2.au_id, SUM(T_ROYALTY+ADVANCE)
 	FROM part2
 	GROUP BY lab2.au_id
 	LIMIT 3;
